원본: [Transformations](https://learnopengl.com/Getting-started/Transformations)
...
!!! note ""
    현재는 빌딩이 필요해 진것으로 보입니다. 최초의 창에서 설명했듯이, CMake를 사용해 빌드할 수 있습니다.

    또한 리눅스인 경우 glm은 pkg-config로 지정해 주지 않아도 알아서 컴파일을 해주는걸로 보입니다.
