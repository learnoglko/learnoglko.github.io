...
원본: [Introduction](https://learnopengl.com/Introduction)

!!! warning ""
    이 번역은 아직 미완성입니다. 또한 별도의 검수가 따로 진행되지 않은 번역이란 점에 유의하세요.
...
또한 단원과 챕터가 혼용되어있고, 일부 챕터에선 "아티팩트"라는 단어를 사용하는데, 그래픽 버그라는 뜻입니다.
