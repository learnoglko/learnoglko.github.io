...
LearnOpenGL은 여러 개의 일반 섹션으로 나뉩니다. 각 섹션은 여러 장으로 구성되어 있으며, 각 장은 다양한 개념을 자세히 설명합니다. 각 장은 위쪽 목차 메뉴에서 찾을 수 있습니다. 개념은 선형적으로 학습되므로 별도의 지시가 없는 한 처음부터 끝까지 순차적으로 학습하는 것이 좋습니다. 각 장에서는 배경 이론과 실제 코드를 설명합니다.
